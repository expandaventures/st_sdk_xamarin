...
using MapsPosition = Xamarin.Forms.Maps.Position;

namespace SinTrafico.Xamarin.Forms.Models
{
    public class Pin : BindableObject
    {
        ...
        public static readonly BindableProperty PositionProperty = BindableProperty.Create("Position", typeof(MapsPosition), typeof(Pin), default(MapsPosition));
        ...
        public MapsPosition Position
        {
            get { return (MapsPosition)GetValue(PositionProperty); }
