...
namespace SinTrafico.Xamarin.Android.Renderers
{
    public class MapRenderer : ViewRenderer<Map, MapView>, GoogleMap.IOnCameraMoveListener, IOnMapReadyCallback
    {
        ...
        void MoveToRegion(MapSpan span, bool animate)
        {
            ...
            catch (IllegalStateException exc)
            {
                ...
                global::Android.Util.Log.Warn("Xamarin.Forms MapRenderer", $"MoveToRegion exception: {exc}");
            }
        }
        ...
        void UpdateVisibleRegion(LatLng pos)
        {
            ...
            Element.SetVisibleRegion(new MapSpan(new global::Xamarin.Forms.Maps.Position(pos.Latitude, pos.Longitude), dlat, dlong));
        }
