...
namespace SinTrafico.Xamarin.iOS.Renderers
{
    ...
    public class MapRenderer : ViewRenderer
    {
        ...
        void MkMapViewOnRegionChanged(object sender, MKMapViewChangeEventArgs mkMapViewChangeEventArgs)
        {
            ...
            mapModel.SetVisibleRegion(new MapSpan(new global::Xamarin.Forms.Maps.Position(mkMapView.Region.Center.Latitude, mkMapView.Region.Center.Longitude), mkMapView.Region.Span.LatitudeDelta, mkMapView.Region.Span.LongitudeDelta));
        }
